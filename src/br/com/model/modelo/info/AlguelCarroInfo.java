package br.com.model.modelo.info;

import java.math.BigDecimal;

import br.com.model.modelo.Carro;

public class AlguelCarroInfo {
	...
	public AlguelCarroInfo(Carro carro, Long totalAlugueis, Number valorMaximo, Number valorMedio) {
		this.carro = carro;
